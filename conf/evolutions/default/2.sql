...
INSERT INTO users (name, email, password, birthday, introduce, profile_img, department_id) VALUES('user3','email3@example.com', 'password3', '2000-11-13','user3です', 'img3',3);
